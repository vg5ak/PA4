...
"Meggy.Color"         {return new Symbol(sym.COLOR_LITERAL,new SymbolValue(yyline+1, yychar+1, yytext()));}
"Meggy.Button"         {return new Symbol(sym.BUTTON_LITERAL,new SymbolValue(yyline+1, yychar+1, yytext()));}
"Meggy.Tone"         {return new Symbol(sym.TONE_LITERAL,new SymbolValue(yyline+1, yychar+1, yytext()));}

"this"                  {return new Symbol(sym.THIS,new SymbolValue(yyline+1, yychar+1, yytext()));}
"Meggy.UMINUS"          {return new Symbol(sym.UMINUS,new SymbolValue(yyline+1, yychar+1, yytext()));}
...
[a-z_A-Z][a-z_A-Z0-9]*          {return new Symbol(sym.ID, new SymbolValue(yyline+1, yychar+1, yytext()));}
